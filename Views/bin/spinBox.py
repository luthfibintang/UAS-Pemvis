...
class FloatSpinbox(CTkFrame):
    def __init__(self, *args,
        ...
        self.configure(fg_color=("white", "white"))  # set frame color
        ...
        self.entry = CTkEntry(self, width=width-(2*height), height=height-6, border_width=0, state="disabled")
        self.entry.grid(row=0, column=1, columnspan=1, padx=3, pady=3, sticky="ew")

        self.add_button = CTkButton(self, text="+", width=height-6, height=height-6, fg_color="black",
